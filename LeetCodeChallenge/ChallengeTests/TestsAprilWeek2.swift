...
// April Edition
class TestsAprilWeek2: XCTestCase {
    let sol8 = AprilSolDay8()
    let sol9 = AprilSolDay9()
    let sol11 = AprilSolDay11()
    let sol12 = AprilSolDay12()
    let sol13 = AprilSolDay13()
    let sol14 = AprilSolDay14()
    ...
    func testMinStack1() {
        let minStack = AprilSolDay10.MinStack()
        minStack.push(-2)
        minStack.push(0)
        minStack.push(-3)
        minStack.push(-6)
