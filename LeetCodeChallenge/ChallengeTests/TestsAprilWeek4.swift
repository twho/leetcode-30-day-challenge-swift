...
// April Edition
class TestsAprilWeek4: XCTestCase {
    let sol22 = AprilSolDay22()
    let sol23 = AprilSolDay23()
    let sol25 = AprilSolDay25()
    let sol26 = AprilSolDay26()
    let sol27 = AprilSolDay27()
    ...
    func testLRUCache1() {
        let cache = AprilSolDay24.LRUCache(2)
        cache.put(1, 1)
        cache.put(2, 2)
    ...
    func testLRUCache2() {
        let cache = AprilSolDay24.LRUCache(5)
        cache.put(1, 10)
        cache.put(2, 20)
        cache.put(3, 30)
        cache.put(4, 40)
    ...
    func testFirstUniqueNumber1() {
        let firstUnique = AprilSolDay28.FirstUnique([2, 3, 5])
    ...
    func testFirstUniqueNumber2() {
        let firstUnique = AprilSolDay28.FirstUnique([7, 7, 7, 7, 7, 7])
        XCTAssertEqual(-1, firstUnique.showFirstUnique())
        firstUnique.add(7)
        firstUnique.add(3)
        firstUnique.add(3)
    ...
    func testFirstUniqueNumber3() {
        let firstUnique = AprilSolDay28.FirstUnique([809])
