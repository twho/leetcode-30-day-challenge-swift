...
// April Edition
class TestsAprilWeek1: XCTestCase {
    let sol1 = AprilSolDay1()
    let sol2 = AprilSolDay2()
    let sol3 = AprilSolDay3()
    let sol4 = AprilSolDay4()
    let sol5 = AprilSolDay5()
    let sol6 = AprilSolDay6()
    let sol7 = AprilSolDay7()
